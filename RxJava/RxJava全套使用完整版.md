...
![Observable](../assets/RxJava/legend.png)
...
![img](../assets/RxJava/S.AsyncSubject.png) 

然而，如果原始的Observable因为发生了错误而终止，AsyncSubject将不会发射任何数据，只是简单的向前传递这个错误通知。 ![img](../assets/RxJava/S.AsyncSubject.e.png)

### BehaviorSubject

当观察者订阅BehaviorSubject时，它开始发射原始Observable最近发射的数据（如果此时还没有收到任何数据，它会发射一个默认值），然后继续发射其它任何来自原始Observable的数据。 ![img](../assets/RxJava/S.BehaviorSubject.png)

然而，如果原始的Observable因为发生了一个错误而终止，BehaviorSubject将不会发射任何数据，只是简单的向前传递这个错误通知。 

![1591942806410](../assets/RxJava/1591942806410.png)

### PublishSubject

PublishSubject只会把在订阅发生的时间点之后来自原始Observable的数据发射给观察者。需要注意的是，PublishSubject可能会一创建完成就立刻开始发射数据（除非你可以阻止它发生），因此这里有一个风险：在Subject被创建后到有观察者订阅它之前这个时间段内，一个或多个数据可能会丢失。如果要确保来自原始Observable的所有数据都被分发，你需要这样做：或者使用Create创建那个Observable以便手动给它引入"冷"Observable的行为（当所有观察者都已经订阅时才开始发射数据），或者改用ReplaySubject。 ![1591942904333](../assets/RxJava/1591942904333.png)

如果原始的Observable因为发生了一个错误而终止，PublishSubject将不会发射任何数据，只是简单的向前传递这个错误通知。 ![1591942918703](../assets/RxJava/1591942918703.png)
...
![1591942952999](../assets/RxJava/1591942952999.png)
...
![1591943004945](../assets/RxJava/1591943004945.png)
...
![1591943032040](../assets/RxJava/1591943032040.png)
...
![1591943067153](../assets/RxJava/1591943067153.png)
...
![1591943110831](../assets/RxJava/1591943110831.png)
...
![1591943174175](../assets/RxJava/1591943174175.png)
...
![1591943188036](../assets/RxJava/1591943188036.png)
...
![1591943206761](../assets/RxJava/1591943206761.png)
...
![1591943219342](../assets/RxJava/1591943219342.png)
...
![1591943237874](../assets/RxJava/1591943237874.png)
...
![1591943735625](../assets/RxJava/1591943735625.png)

`Interval`操作符返回一个Observable，它按固定的时间间隔发射一个无限递增的整数序列。

![1591943793205](../assets/RxJava/1591943793205.png)
...
![1591943808798](../assets/RxJava/1591943808798.png)
...
![1591943931779](../assets/RxJava/1591943931779.png)
...
![1591944307222](../assets/RxJava/1591944307222.png)

Repeat重复地发射数据。某些实现允许你重复的发射某个数据序列，还有一些允许你限制重复的次数。

![1591944372759](../assets/RxJava/1591944372759.png)
...
![1591944499540](../assets/RxJava/1591944499540.png)
...
![1591944526855](../assets/RxJava/1591944526855.png)
...
![1591944610043](../assets/RxJava/1591944610043.png)
...
![1591944629952](../assets/RxJava/1591944629952.png)
...
![1591944648965](../assets/RxJava/1591944648965.png)
...
![1591944721935](../assets/RxJava/1591944721935.png)
...
![1591944814146](../assets/RxJava/1591944814146.png)
...
![1591944837311](../assets/RxJava/1591944837311.png)
...
![1591944861505](../assets/RxJava/1591944861505.png)
...
![1591944874321](../assets/RxJava/1591944874321.png)
...
![1591944896905](../assets/RxJava/1591944896905.png)
...
![1591944911728](../assets/RxJava/1591944911728.png)
...
![1591945055261](../assets/RxJava/1591945055261.png)
...
![1591945069257](../assets/RxJava/1591945069257.png)
...
![1591945115907](../assets/RxJava/1591945115907.png)
...
![1591945131075](../assets/RxJava/1591945131075.png)
...
![1591945144764](../assets/RxJava/1591945144764.png)
...
![1591945163299](../assets/RxJava/1591945163299.png)
...
![1591945177282](../assets/RxJava/1591945177282.png)
...
](../assets/RxJava/1591945191477.png)
...
![1591945232298](../assets/RxJava/1591945232298.png)
...
![1591945245093](../assets/RxJava/1591945245093.png)
...
![1591945261158](../assets/RxJava/1591945261158.png)
...
![1591945279035](../assets/RxJava/1591945279035.png)
...
![1591945293811](../assets/RxJava/1591945293811.png)
...
![1591945312676](../assets/RxJava/1591945312676.png)
...
![1591945327213](../assets/RxJava/1591945327213.png)
...
![encode](../assets/RxJava/St.encode.png)
...
![1591947072622](../assets/RxJava/1591947072622.png)
...
![scanSeed](../assets/RxJava/scanSeed.png)
...
![window](../assets/RxJava/window.C.png)
...
![window1](../assets/RxJava/window1.png)
...
![window2](../assets/RxJava/window2.png)
...
![window3](../assets/RxJava/window3.png)
...
![window4](../assets/RxJava/window4.png)
...
![window5](../assets/RxJava/window5.png)
...
![window6](../assets/RxJava/window6.png)
...
![window7](../assets/RxJava/window7.png)
...
![bp.window1](../assets/RxJava/bp.window1.png)
...
![bp.window2](../assets/RxJava/bp.window2.png)
...
![debounce](../assets/RxJava/debounce.c.png)
...
![debounce](../assets/RxJava/debounce.png)
...
![debounce](../assets/RxJava/debounce.f.png)
...
![distinct](../assets/RxJava/distinct.c.png)
...
![distinct](../assets/RxJava/distinct.png)
...
![distinct](../assets/RxJava/distinct.key.png)
...
![distinctUntilChanged](../assets/RxJava/distinctUntilChanged.png)

RxJava还是实现了一个`distinctUntilChanged`操作符。它只判定一个数据和它的直接前驱是否是不同的。

### distinctUntilChanged(Func1)

![distinctUntilChanged.key](../assets/RxJava/distinctUntilChanged.key.png)
...
![elementAt](../assets/RxJava/elementAt.c.png)

`ElementAt`操作符获取原始Observable发射的数据序列指定索引位置的数据项，然后当做自己的唯一数据发射。

![elementAt](../assets/RxJava/elementAt.png)
...
![elementAtOrDefault](../assets/RxJava/elementAtOrDefault.png)
...
![filter](../assets/RxJava/filter.c.png)

`Filter`操作符使用你指定的一个谓词函数测试数据项，只有通过测试的数据才会被发射。

![filter](../assets/RxJava/filter.png)
...
![ofType](../assets/RxJava/ofClass.png)
...
![first](../assets/RxJava/first.c.png)
...
![ignoreElements](../assets/RxJava/ignoreElements.c.png)
...
![last](../assets/RxJava/lastOrDefault.png)
...
![last](../assets/RxJava/lastOrDefault.p.png)
...
![sample](../assets/RxJava/sample.c.png)
...
![sample](../assets/RxJava/sample.png)
...
![sample](../assets/RxJava/sample.o.png)
...
![throttleFirst](../assets/RxJava/throttleFirst.png)
...
![skip](../assets/RxJava/skip.c.png)

使用`Skip`操作符，你可以忽略Observable'发射的前N项数据，只保留之后的数据。

![skip](../assets/RxJava/skip.png)
...
![skipLast](../assets/RxJava/skipLast.c.png)

使用`SkipLast`操作符修改原始Observable，你可以忽略Observable'发射的后N项数据，只保留前面的数据。

![skipLast](../assets/RxJava/skipLast.png)
...
![skipLast](../assets/RxJava/skipLast.t.png)
...
![takeLast](../assets/RxJava/takeLast.c.png)

使用`TakeLast`操作符修改原始Observable，你可以只发射Observable'发射的后N项数据，忽略前面的数据。

### taskLast.n

![takeLast](../assets/RxJava/takeLast.n.png)
...
![takeLast](../assets/RxJava/takeLast.t.png)
...
![takeLast](../assets/RxJava/takeLastBuffer.png)
...
![and/then/when](../assets/RxJava/and_then_when.C.png)
...
![and/then/when](../assets/RxJava/and_then_when.png)
...
![combineLatest](../assets/RxJava/combineLatest.c.png)
...
![combineLatest](../assets/RxJava/combineLatest.png)
...
![withLatestFrom](../assets/RxJava/withLatestFrom.png)
...
![groupJoin](../assets/RxJava/groupJoin.c.png)
...
![groupJoin](../assets/RxJava/groupJoin.png)
...
![st.join](../assets/RxJava/St.join.png)
...
![merge](../assets/RxJava/merge.c.png)
...
![mergeDelayError](../assets/RxJava/mergeDelayError.C.png)
...
![merge](../assets/RxJava/merge.io.png)
...
![merge](../assets/RxJava/mergeDelayError.png)
...
![startWith](../assets/RxJava/startWith.o.png)
...
![switch](../assets/RxJava/switch.c.png)
...
![onErrorReturn](../assets/RxJava/onErrorReturn.png)
...
![onErrorResumeNext](../assets/RxJava/onErrorResumeNext.png)
...
![onExceptionResumeNext](../assets/RxJava/onExceptionResumeNextViaObservable.png)
...
![retry](../assets/RxJava/retry.C.png)
...
![retryWhen](../assets/RxJava/retryWhen.f.png)
...
![delay](../assets/RxJava/delay.o.png)
...
![delay](../assets/RxJava/delay.oo.png)
...
![delay](../assets/RxJava全套使用完整版/delaySubscription.png)
...
![1591954842495](../assets/RxJava/1591954842495.png)
...
![1591954926216](../assets/RxJava/1591954926216.png)
...
![doOnEach](../assets/RxJava/doOnEach.png)
...
![doOnNext](../assets/RxJava/doOnNext.png)
...
![doOnSubscribe](../assets/RxJava/doOnSubscribe.png)
...
![doOnUnsubscribe](../assets/RxJava/doOnUnsubscribe.png)
...
![doOnCompleted](../assets/RxJava/doOnCompleted.png)
...
![doOnError](../assets/RxJava/doOnError.png)
...
![doOnTerminate](../assets/RxJava/doOnTerminate.png)
...
![finallyDo](../assets/RxJava/finallyDo.png)
...
![materialize](../assets/RxJava/materialize.c.png)
...
![dematerialize](../assets/RxJava/dematerialize.c.png)
...
![observeOn](../assets/RxJava/observeOn.c.png)
...
![observeOn](../assets/RxJava/observeOn.e.png)
...
![img](../assets/RxJava/serialize.c.png)
...
![SubscribeOn](../assets/RxJava/subscribeOn.c.png)
...
![TimeInterval](../assets/RxJava/timeInterval.c.png)
...
![Timeout](../assets/RxJava/timeout.2.png)
...
![Timeout](../assets/RxJava/timeout.3.png)
...
![Timeout](../assets/RxJava/timeout.4.png)
...
![Timeout](../assets/RxJava/timeout.5.png)
...
![Timeout](../assets/RxJava/timeout.6.png)
...
![Timestamp](../assets/RxJava/timestamp.c.png)
...
![getIterator](../assets/RxJava/B.getIterator.png)
...
![toFuture](../assets/RxJava/B.toFuture.png)
...
![toIterable](../assets/RxJava/B.toIterable.png)
...
![toList](../assets/RxJava/toList.png)
...
![toMultiMap](../assets/RxJava/toMultiMap.png)
...
![toSortedList](../assets/RxJava/toSortedList.png)
...
![exists](../assets/RxJava/exists.png)
...
![isEmpty](../assets/RxJava/isEmpty.png)
...
![defaultIfEmtpy](../assets/RxJava/defaultIfEmpty.c.png)
...
![skipUntil](../assets/RxJava/skipUntil.c.png)
...
![skipWhile](../assets/RxJava/skipWhile.c.png)
...
![takeUntil](../assets/RxJava/takeUntil.c.png)
...
![takeUntil](../assets/RxJava/takeUntil.png)
...
![takeUntil](../assets/RxJava/takeUntil.p.png)
...
![takeWhile](../assets/RxJava/takeWhile.c.png)
...
![average](../assets/RxJava/average.c.png)
...
![average](../assets/RxJava/average.f.png)
...
![count](../assets/RxJava/count.c.png)
...
![concat](../assets/RxJava/concat.c.png)
...
![concat](../assets/RxJava/concat.png)
...
![reduce](../assets/RxJava/reduce.c.png)
...
![reduce](../assets/RxJava/reduce.png)
...
![reduce](../assets/RxJava/reduceSeed.png)
...
![collect](../assets/RxJava/collect.png)
...
![publishConnect](../assets/RxJava/publishConnect.png)
...
![connect](../assets/RxJava/publishConnect.c.png)
...
![connect](../assets/RxJava/publishConnect.png)
...
![publish](../assets/RxJava/publishConnect.c.png)
...
![publish](../assets/RxJava/publishConnect.png)

RxJava的实现为`publish`。

- Javadoc: [publish()](http://reactivex.io/RxJava/javadoc/rx/Observable.html#publish())

![publish](../assets/RxJava/publishConnect.f.png)
...
![refCount](../assets/RxJava/publishRefCount.c.png)
...
![refCount](../assets/RxJava/publishRefCount.png)
...
![replay](../assets/RxJava/replay.c.png)
...
![replay](../assets/RxJava/replay.png)
...
![replay](../assets/RxJava/replay.f.png)
